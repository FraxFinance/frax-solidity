...
module.exports = async function(deployer, network, accounts) {
	...
	await pair_instance_FRAX_USDC.transfer(METAMASK_ADDRESS, new BigNumber("15e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
	await pair_instance_FRAX_FXS.transfer(METAMASK_ADDRESS, new BigNumber("15e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
	await pair_instance_FXS_WETH.transfer(METAMASK_ADDRESS, new BigNumber("15e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
