...
contract CurveAMO is AccessControl {
    ...
    function get_D() public view returns (uint256) {
        ...
        uint256[2] memory _xp =
            [three_pool_erc20.balanceOf(frax3crv_metapool_address), FRAX.balanceOf(frax3crv_metapool_address)];
    ...
    function metapoolWithdrawAtCurRatio(
        ...
        uint256 min_frax,
        uint256 min_3pool
    ) public onlyByOwnerOrGovernance returns (uint256 frax_received) {
