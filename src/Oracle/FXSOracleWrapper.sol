...
contract FXSOracleWrapper is Owned {
    ...
    constructor(address _creator_address, address _timelock_address) public Owned(_creator_address) {
    ...
    function getETHPrice() public view returns (uint256) {
        return
            uint256(chainlink_eth_oracle.getLatestPrice()).mul(PRICE_PRECISION).div(10**chainlink_eth_oracle_decimals);
    }
