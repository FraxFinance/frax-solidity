...
contract SigRelayer2 {
    ...
    function signatoryFromDelegateSig(
        address delegatee,
        uint256 nonce,
        uint256 expiry,
        uint8 v,
        ...
        bytes32 domainSeparator =
            keccak256(abi.encode(DOMAIN_TYPEHASH, keccak256(bytes(name)), getChainId(), compToken));
    ...
    function signatoryFromVoteSig(
        ...
        bytes32 domainSeparator =
            keccak256(abi.encode(DOMAIN_TYPEHASH, keccak256(bytes(name2)), getChainId(), governorBravo));
