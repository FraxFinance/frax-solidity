...
contract('PangolinLiquidityAMO-Tests', async (accounts) => {
	...
	it("Main test", async () => {
		...
		await usdc_instance.transfer(pangolin_liquidity_amo_instance.address, new BigNumber("100000e6"), { from: ADDRESS_WITH_USDC });
		...
		// await pangolin_liquidity_amo_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, { from: process.env.AVALANCHE_ONE_ADDRESS });
		...
		// await pangolin_liquidity_amo_instance.acceptOwnership({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		let the_allocations = await pangolin_liquidity_amo_instance.showAllocations.call();
		let the_token_balances = await pangolin_liquidity_amo_instance.showTokenBalances.call();
		...
		// await canFRAX_instance.addMinter(pangolin_liquidity_amo_instance.address, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		// await canFXS_instance.addMinter(pangolin_liquidity_amo_instance.address, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log("Give the bridge backer some canFRAX and canFXS");
		await canFRAX_instance.transfer(pangolin_liquidity_amo_instance.address, initial_dump_amt_amo_canToken, { from: GOVERNOR_GUARDIAN_ADDRESS });
		await canFXS_instance.transfer(pangolin_liquidity_amo_instance.address, initial_dump_amt_amo_canToken, { from: GOVERNOR_GUARDIAN_ADDRESS });

		console.log("Print some info");
		old_allocations = the_allocations;
		old_balances = the_token_balances;
		the_allocations = await pangolin_liquidity_amo_instance.showAllocations.call();
		the_token_balances = await pangolin_liquidity_amo_instance.showTokenBalances.call();
		...
		const FXS_PRICE_FROM_LP0_E18 = new BigNumber(await pangolin_liquidity_amo_instance.pair_reserve_ratio_E18.call(CONTRACT_ADDRESSES.avalanche.pair_tokens["Pangolin canFRAX/canFXS"], CONTRACT_ADDRESSES.avalanche.canonicals.FRAX));
		...
		await pangolin_liquidity_amo_instance.addLiquidity(
		...
		const FXS_PRICE_FROM_LP2_E18 = new BigNumber(await pangolin_liquidity_amo_instance.pair_reserve_ratio_E18.call(CONTRACT_ADDRESSES.avalanche.pair_tokens["Pangolin canFXS/USDC.e"], CONTRACT_ADDRESSES.avalanche.collaterals["USDC.e"]));
		...
		await pangolin_liquidity_amo_instance.swapTokens(
			CONTRACT_ADDRESSES.avalanche.canonicals.FRAX,
			swap_direct_amt,
			CONTRACT_ADDRESSES.avalanche.collaterals["USDC.e"],
			0,
		...
		await pangolin_liquidity_amo_instance.swapTokensWithCustomPath(
			CONTRACT_ADDRESSES.avalanche.canonicals.FRAX,
			swap_amt,
			0,
			[
		...
		await pangolin_liquidity_amo_instance.giveFRAXBack(new BigNumber("250e18"), false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give back 250 canFXS");
		await pangolin_liquidity_amo_instance.giveFXSBack(new BigNumber("250e18"), false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give back 250 USDC.e");
		await pangolin_liquidity_amo_instance.giveCollatBack(new BigNumber("250e6"), false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		await pangolin_liquidity_amo_instance.giveFRAXBack(new BigNumber("1e18"), true, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give back 1 canFXS");
		await pangolin_liquidity_amo_instance.giveFXSBack(new BigNumber("1e18"), true, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		// AEB bans contract calls back
		// console.log("Give back 1 USDC.e");
		// await pangolin_liquidity_amo_instance.giveCollatBack(new BigNumber("1e6"), true, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		await pangolin_liquidity_amo_instance.execute(canFRAX_instance.address, 0, calldata, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
