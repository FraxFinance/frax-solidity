...
contract('FPIControllerPool-Tests', async (accounts) => {
	...
	it("Main test", async () => {
		...
		await twamm_router_instance.swapExactTokensForTokens(BIG18, 0, [fpi_instance.address, frax_instance.address], COLLATERAL_FRAX_AND_FXS_OWNER, 1947242944, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		await twamm_router_instance.swapExactTokensForTokens(BIG18, 0, [frax_instance.address, fpi_instance.address], COLLATERAL_FRAX_AND_FXS_OWNER, 1947242944, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
