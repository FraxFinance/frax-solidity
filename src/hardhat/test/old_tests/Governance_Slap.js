...
module.exports = async function(deployer, network, accounts) {
	...
	if (process.env.MIGRATION_MODE == 'ganache'){
		...
		routerInstance = await UniswapV2Router02_Modified.at(CONTRACT_ADDRESSES[process.env.MIGRATION_MODE].uniswap.router); 
		uniswapFactoryInstance = await UniswapV2Factory.at(CONTRACT_ADDRESSES[process.env.MIGRATION_MODE].uniswap.factory); 
