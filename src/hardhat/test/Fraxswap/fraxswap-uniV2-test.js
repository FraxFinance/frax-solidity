...
describe("UniswapV2 Tests", function () {
    ...
    describe("Core Tests - FraxswapPair", function () {
    ...
    describe("Core Tests - FraxswapFactory", function () {
    ...
    describe("Core Tests - UniswapV2ERC20", function () {
        ...
        beforeEach(async function () {
            ...
            const TOKEN = await ethers.getContractFactory("contracts/Fraxswap/core/test/ERC20CoreTest.sol:ERC20CoreTest")
        ...
        it('name, symbol, decimals, totalSupply, balanceOf, DOMAIN_SEPARATOR, PERMIT_TYPEHASH', async () => {
            ...
            expect(name).to.eq('Fraxswap V2')
            expect(await token.symbol()).to.eq('FS-V2')
    ...
    describe("Periphery Tests - FraxswapRouter", function () {
        ...
        describe("FraxswapRouter", function () {
            ...
            it('getAmountsOut', async () => {
                ...
                await expect(router.getAmountsOut(bigNumberify(2), [token0.address])).to.be.revertedWith(
                    'FraxswapRouterLibrary: INVALID_PATH'
                )
        ...
        describe('fee-on-transfer tokens: reloaded', () => {
            ...
            beforeEach(async function () {
                ...
                DTT = await (await ethers.getContractFactory(
                    "contracts/Fraxswap/periphery/test/DeflatingERC20.sol:DeflatingERC20"
