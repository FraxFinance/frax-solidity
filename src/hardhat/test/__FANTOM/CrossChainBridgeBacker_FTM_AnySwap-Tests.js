...
contract('CrossChainBridgeBacker_FTM_AnySwap-Tests', async (accounts) => {
	...
	it("Main test", async () => {
		...
		console.log(chalk.hex("#ff8b3d").bold("===========================NOTE SOME SpiritSwapLiquidityAMO INFO==========================="));
		console.log("Print some info [SpiritSwapLiquidityAMO]");
		let the_allocations_spiritswap_amo = await spiritSwapLiquidityAMO_instance.showAllocations.call();
		let the_token_balances_spiritswap_amo = await spiritSwapLiquidityAMO_instance.showTokenBalances.call();
		utilities.printAllocations('SpiritSwapLiquidityAMO', the_allocations_spiritswap_amo, null);
		utilities.printTokenBalances('SpiritSwapLiquidityAMO', the_token_balances_spiritswap_amo, null);
		...
		console.log("Lend 1000 canFRAX");
		await cc_bridge_backer_instance.lendFraxToAMO(spiritSwapLiquidityAMO_instance.address, new BigNumber("1000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Lend 1000 canFXS");
		await cc_bridge_backer_instance.lendFxsToAMO(spiritSwapLiquidityAMO_instance.address, new BigNumber("1000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Lend 1000 anyUSDC");
		await cc_bridge_backer_instance.lendCollatToAMO(spiritSwapLiquidityAMO_instance.address, new BigNumber("1000e6"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		the_allocations_spiritswap_amo = await spiritSwapLiquidityAMO_instance.showAllocations.call();
		the_token_balances_spiritswap_amo = await spiritSwapLiquidityAMO_instance.showTokenBalances.call();
		utilities.printAllocations('SpiritSwapLiquidityAMO', the_allocations_spiritswap_amo, old_allocations_spiritswap_amo);
		utilities.printTokenBalances('SpiritSwapLiquidityAMO', the_token_balances_spiritswap_amo, old_balances_spiritswap_amo);
		...
		await spiritSwapLiquidityAMO_instance.giveFRAXBack(new BigNumber("250e18"), false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give back 250 canFXS");
		await spiritSwapLiquidityAMO_instance.giveFXSBack(new BigNumber("250e18"), false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give back 250 anyUSDC");
		await spiritSwapLiquidityAMO_instance.giveCollatBack(new BigNumber("250e6"), false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log("Give 100 canFRAX");
		await spiritSwapLiquidityAMO_instance.giveFRAXBack(new BigNumber("100e18"), true, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give 100 canFXS");
		await spiritSwapLiquidityAMO_instance.giveFXSBack(new BigNumber("100e18"), true, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Give 100 anyUSDC");
		await spiritSwapLiquidityAMO_instance.giveCollatBack(new BigNumber("100e6"), true, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
