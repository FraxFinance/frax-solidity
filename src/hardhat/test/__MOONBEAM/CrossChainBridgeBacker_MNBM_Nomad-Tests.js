...
// Bridges
const CrossChainBridgeBacker_MNBM_Nomad = artifacts.require("Bridges/Harmony/CrossChainBridgeBacker_MNBM_Nomad");
...
contract('CrossChainBridgeBacker_MNBM_Nomad-Tests', async (accounts) => {
	CONTRACT_ADDRESSES = constants.CONTRACT_ADDRESSES;

	// Account addresses
	let ORIGINAL_MOONBEAM_ONE_ADDRESS;
	...
	// Useful addresses
	const ADDRESS_WITH_MADFRAX = "0x104E5d38a2d646FFaf936d0a4Af876e56B5B14B3";
	const ADDRESS_WITH_MADFXS = "0x104E5d38a2d646FFaf936d0a4Af876e56B5B14B3";
	const ADDRESS_WITH_MADUSDC = "0x104E5d38a2d646FFaf936d0a4Af876e56B5B14B3";
    ...
    beforeEach(async() => {
		...
		// Constants
		ORIGINAL_MOONBEAM_ONE_ADDRESS = process.env.MOONBEAM_ONE_ADDRESS;
		...
		madFRAX_instance = await madFRAX.deployed();
		madFXS_instance = await madFXS.deployed();
		...
		madUSDC_instance = await madUSDC.deployed();

		// Fill bridge instances
		cc_bridge_backer_instance = await CrossChainBridgeBacker_MNBM_Nomad.deployed();
	...
	it("Main test", async () => {
		...
		await hre.network.provider.request({
			method: "hardhat_impersonateAccount",
			params: [ADDRESS_WITH_MADFRAX]
		});    

		console.log(chalk.yellow('========== GIVE COLLATERAL_FRAX_AND_FXS_OWNER SOME madFRAX  =========='));
		await madFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber("10000e18"), { from: ADDRESS_WITH_MADFRAX });
		...
		await hre.network.provider.request({
			method: "hardhat_impersonateAccount",
			params: [ADDRESS_WITH_MADFXS]
		});    

		console.log(chalk.yellow('========== GIVE COLLATERAL_FRAX_AND_FXS_OWNER SOME madFXS  =========='));
		await madFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber("1000e18"), { from: ADDRESS_WITH_MADFXS });
		...
		await hre.network.provider.request({
			method: "hardhat_impersonateAccount",
			params: [ADDRESS_WITH_MADUSDC]
		});    

		console.log(chalk.yellow('========== GIVE COLLATERAL_FRAX_AND_FXS_OWNER SOME madUSDC  =========='));
		await madUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber("10000e6"), { from: ADDRESS_WITH_MADUSDC });
		...
		// await cc_bridge_backer_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, { from: process.env.MOONBEAM_ONE_ADDRESS });
	
		console.log(chalk.yellow('========== SET COLLATERAL_FRAX_AND_FXS_OWNER AS THE canFRAX OWNER  =========='));
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, { from: process.env.MOONBEAM_ONE_ADDRESS });
	
		console.log(chalk.yellow('========== SET COLLATERAL_FRAX_AND_FXS_OWNER AS THE canFXS OWNER  =========='));
		await canFXS_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, { from: process.env.MOONBEAM_ONE_ADDRESS });
		...
		await madFRAX_instance.transfer(canFRAX_instance.address, new BigNumber("5000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await madFXS_instance.transfer(canFXS_instance.address, new BigNumber("500e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log(chalk.hex("#ff8b3d").bold("=========================DUMP IN SOME madFRAX [SIMULATES BRIDGE]========================="));
		const dump_amt_madFRAX = new BigNumber("125e18");
		console.log("dump_amt_madFRAX: ", dump_amt_madFRAX.div(BIG18).toNumber());

		await madFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_madFRAX, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log(chalk.hex("#ff8b3d").bold("=========================DUMP IN SOME madFXS [SIMULATES BRIDGE]========================="));
		const dump_amt_madFXS = new BigNumber("50e18");
		console.log("dump_amt_madFXS: ", dump_amt_madFXS.div(BIG18).toNumber());
		
		await madFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_madFXS, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		await madUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log("Self-Bridge back canFRAX (no internal swap to madFRAX)");
		await cc_bridge_backer_instance.selfBridge(0, self_bridge_no_swap_amt_E18, false, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		console.log("Self-Bridge back canFXS (no internal swap to madFXS)");
		...
		console.log(chalk.hex("#ff8b3d").bold("===========================GIVE THE canFRAX CONTRACT SOME madFRAX ==========================="));
		const givemadFRAX_amt = new BigNumber("10e18");
		console.log("givemadFRAX_amt: ", givemadFRAX_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.giveAnyToCan(0, givemadFRAX_amt, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log(chalk.hex("#ff8b3d").bold("===========================SWAP madFRAX for canFRAX manually==========================="));
		const swapAnyForCanonical_amt_madFRAX = new BigNumber("50e18");
		console.log("swapAnyForCanonical_amt_madFRAX: ", swapAnyForCanonical_amt_madFRAX.div(BIG18).toNumber());

		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_madFRAX, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log(chalk.hex("#ff8b3d").bold("===========================SWAP madFXS for canFXS manually==========================="));
		const swapAnyForCanonical_amt_madFXS = new BigNumber("5e18");
		console.log("swapAnyForCanonical_amt_madFXS: ", swapAnyForCanonical_amt_madFXS.div(BIG18).toNumber());

		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_madFXS, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log(chalk.hex("#ff8b3d").bold("===========================MINT SOME canFRAX and madFRAX==========================="));
		...
		console.log(chalk.hex("#ff8b3d").bold("===========================BURN SOME canFRAX and madFRAX==========================="));
		...
		console.log(chalk.hex("#ff8b3d").bold("==========COLLECT SOME madFRAX AND madFXS FROM THE CANONICAL CONTRACTS=========="));
		const canToken_collect_amt = new BigNumber("1e18");
		console.log("canToken_collect_amt: ", canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, madFRAX_instance.address, canToken_collect_amt, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await cc_bridge_backer_instance.collectBridgeTokens(1, madFXS_instance.address, canToken_collect_amt, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		let amo_usdc_bal_before = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR)).div(BIG6).toNumber();
		...
		let amo_usdc_bal_after = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR)).div(BIG6).toNumber();
		...
		amo_usdc_bal_before = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR)).div(BIG6).toNumber();
		...
		console.log("Give 5 madUSDC");
		await madUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber("5e6"), { from: STAKING_REWARDS_DISTRIBUTOR });
		await cc_bridge_backer_instance.receiveBackViaAMO(madUSDC_instance.address, new BigNumber("5e6"), false, { from: STAKING_REWARDS_DISTRIBUTOR });
		...
		amo_usdc_bal_after = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR)).div(BIG6).toNumber();
		...
		console.log("madUSDC balance [STAKING_REWARDS_DISTRIBUTOR] change: ", amo_usdc_bal_after - amo_usdc_bal_before);
		...
		// console.log("Give back 25 madUSDC");
		...
		console.log("Give 1 madUSDC");
		await madUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber("1e6"), { from: STAKING_REWARDS_DISTRIBUTOR });
		await cc_bridge_backer_instance.receiveBackViaAMO(madUSDC_instance.address, new BigNumber("1e6"), true, { from: STAKING_REWARDS_DISTRIBUTOR });
		...
		await cc_bridge_backer_instance.execute(madFRAX_instance.address, 0, calldata, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
