...
contract('FRAX Core Tests', async (accounts) => {
	// Constants
	...
	it('Check up on the oracles and make sure the prices are set', async () => {
		...
		let frax_price_from_FRAX_USDT = (new BigNumber(await oracle_instance_FRAX_USDT.consult.call(frax_instance.address, new BigNumber("1e18")))).div(BIG6);
		...
		let fxs_price_from_FXS_USDT = (new BigNumber(await oracle_instance_FXS_USDT.consult.call(fxs_instance.address, new BigNumber("1e18")))).div(BIG6);
	...
	it("Deploys a vesting contract and then executes a governance proposal to revoke it", async () => {
		...
		await vestingInstance.setFXSAddress(fxs_instance.address, { from: accounts[0] });
		await fxs_instance.approve(vestingInstance.address, new BigNumber("100000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await fxs_instance.transfer(vestingInstance.address, new BigNumber("100000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		const initial_FXS_balance = new BigNumber(await fxs_instance.balanceOf(accounts[0]));
		const initial_FXS_balance_5 = new BigNumber(await fxs_instance.balanceOf(accounts[5]));
		...
		const acc_0_FXS_balance_change = (new BigNumber(await fxs_instance.balanceOf(accounts[0]))).minus(initial_FXS_balance).div(BIG18);
		const acc_5_FXS_balance_change = (new BigNumber(await fxs_instance.balanceOf(accounts[5]))).minus(initial_FXS_balance_5).div(BIG18);
		...
		await vestingInstance.release({ from: accounts[5] });
		console.log("accounts[5] FXS balance change:", (new BigNumber(await fxs_instance.balanceOf(accounts[5])).minus(initial_FXS_balance_5).div(BIG18)).toNumber());
	});
	...
	it('PART 0: Normal stakes at CR = 100%', async () => {
		...
		console.log("accounts[9] earned():", new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(BIG18).toNumber());
		console.log("====================================================================");

		console.log("wait two weeks so account[9] can earn more, but also turn rewards to 0");

		// Advance a few days
		await time.increase(2 * (7 * 86400) + 1);
		await time.advanceBlock();

		await stakingInstance_FRAX_USDC.setRewardRate(0, { from: STAKING_OWNER });
		...
		await stakingInstance_FRAX_USDC.setMultipliers(3000000, 2000000, { from: STAKING_OWNER });
		await stakingInstance_FRAX_USDC.setRewardRate(new BigNumber("4e17"), { from: STAKING_OWNER });
		console.log("waiting 3 days");
		await time.increase(3 * (86400) + 1);
		await time.advanceBlock();
		await stakingInstance_FRAX_USDC.sync({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		console.log("[flag] accounts[9] staking earned():", new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(BIG18).toString());
		await stakingInstance_FRAX_USDC.setRewardRate(0, { from: STAKING_OWNER });
		console.log("[flag] accounts[9] staking earned():", new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(BIG18).toString());
		...
		await time.advanceBlock();
		await stakingInstance_FRAX_USDC.sync({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		console.log("accounts[9] staking earned():", new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(BIG18).toString());
		await stakingInstance_FRAX_USDC.withdraw(uni_pool_tokens_9, { from: accounts[9] });
	});
	...
	it("updates oracles", async () => {
		console.log(chalk.magenta("updating oracles"));
		await oracle_instance_FRAX_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await oracle_instance_FXS_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await oracle_instance_USDC_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await oracle_instance_USDT_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
	...
	it('Mint some FRAX using USDC as collateral (collateral ratio = 1) [mint1t1FRAX]', async () => {
		...
		const collateral_before = new BigNumber(await usdc_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG6);
		const pool_collateral_before = new BigNumber(await usdc_instance.balanceOf.call(pool_instance_USDC.address)).div(BIG6);
		...
		const collateral_after = new BigNumber(await usdc_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG6);
		const pool_collateral_after = new BigNumber(await usdc_instance.balanceOf.call(pool_instance_USDC.address)).div(BIG6);
	...
	it('Redeem some FRAX for USDC (collateral ratio >= 1) [redeem1t1FRAX]', async () => {
		...
		await usdc_instance.transfer(pool_instance_USDC.address, THREE_THOUSAND_DEC6, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
	...
	it("updates oracles", async () => {
		console.log(chalk.magenta("updating oracles"));
		if(await oracle_instance_FRAX_WETH.canUpdate() == true){
			await oracle_instance_FRAX_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
			await oracle_instance_FXS_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
			await oracle_instance_USDC_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
			await oracle_instance_USDT_WETH.update({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
	...
	it("Reduces the collateral ratio: 1-to-1 Phase => Fractional Phase", async () => {
		...
		console.log("frax_price:", new BigNumber(await frax_instance.frax_price.call()).div(BIG6).toNumber());
		...
		console.log("frax_price:", new BigNumber(await frax_instance.frax_price.call()).div(BIG6).toNumber());
		console.log("setting price_band to 1.5 cents:");
		//await frax_instance.setPriceBand(15000, { from: COLLATERAL_FRAX_AND_FXS_OWNER });
	...
	it('Mint some FRAX using FXS and USDC (collateral ratio between .000001 and .999999) [mintFractionalFRAX]', async () => {
		...
		console.log("accounts[1] votes initial:", (new BigNumber(await fxs_instance.getCurrentVotes(COLLATERAL_FRAX_AND_FXS_OWNER))).div(BIG18).toString());
		// Note the collateral ratio
		const collateral_ratio_before = new BigNumber(await frax_instance.global_collateral_ratio.call()).div(BIG6);
		console.log("collateral_ratio_before: ", collateral_ratio_before.toNumber());
		...
		console.log("accounts[1] votes final:", (new BigNumber(await fxs_instance.getCurrentVotes(COLLATERAL_FRAX_AND_FXS_OWNER))).div(BIG18).toString());
	...
	it("Set the pool ceiling and try to mint above it", async () => {
		...
		await pool_instance_USDC.setPoolParameters(new BigNumber("100e6"), 0, 1, 5500, 4500, 5500, 5500, { from: POOL_CREATOR });
		await fxs_instance.approve(pool_instance_USDC.address, new BigNumber("1000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		await usdc_instance.approve(pool_instance_USDC.address, new BigNumber("1000e6"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		await pool_instance_USDC.setPoolParameters(new BigNumber("5000000e18"), 0, 1, 5500, 4500, 5500, 5500, { from: POOL_CREATOR });
	})
	...
	it('Recollateralizes the system using recollateralizeFRAX()', async () => {
		...
		const frax_info = await frax_instance.frax_info.call();
	...
	it('Make sure the StakingRewards (FRAX/USDC) are initialized', async () => {
		await stakingInstance_FRAX_USDC.sync();
	...
	it('PART 2: Locked stakes', async () => {
		...
		// account[9]
		await stakingInstance_FRAX_USDC.stakeLocked(uni_pool_locked_9, 28 * 86400, { from: accounts[9] });
		await time.advanceBlock();
		...
		await fxs_instance.transfer(stakingInstance_FRAX_USDC.address, new BigNumber("100000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		console.log("stakingInstance FXS balance:", new BigNumber(await fxs_instance.balanceOf(stakingInstance_FRAX_USDC.address)).div(BIG18).toNumber());
		await stakingInstance_FRAX_USDC.getReward({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		console.log("accounts[1] FXS balance:", new BigNumber(await fxs_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber());
	});
	...
	it("FraxPool security tests; SHOULD FAIL", async () => {
		...
		await expectRevert.unspecified(pool_instance_USDC.setPoolParameters(
			...
			new BigNumber("7500e0"),
			new BigNumber("6000e0"),
			{ from: accounts[6] }
		));
	...
	it("Does a fair launch", async () => {
		...
		await fxs_instance.transfer(stakingInstance_FRAX_WETH.address, new BigNumber("1000000e18"), { from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log("staking contract FXS balance:", (new BigNumber(await fxs_instance.balanceOf(stakingInstance_FRAX_WETH.address))).div(BIG18).toNumber());
		...
		let acc2_startingFXSbalance = new BigNumber(await (fxs_instance.balanceOf(accounts[2])));
		let acc3_startingFXSbalance = new BigNumber(await (fxs_instance.balanceOf(accounts[3])));

		console.log("accounts[2] FXS balance:", new BigNumber(await fxs_instance.balanceOf(accounts[2])).div(BIG18).toNumber());
		console.log("accounts[3] FXS balance:", new BigNumber(await fxs_instance.balanceOf(accounts[3])).div(BIG18).toNumber());
		...
		// Note the total lastUpdateTime
		rewards_contract_lastUpdateTime = new BigNumber(await stakingInstance_FRAX_WETH.lastUpdateTime.call());
		console.log("pool lastUpdateTime:", rewards_contract_lastUpdateTime.toNumber());
		...
		console.log(chalk.blue('=== setRewardRate to 0 ==='));
		await stakingInstance_FRAX_WETH.setRewardRate(0, { from: STAKING_OWNER });
		...
		for(let i = 0; i < 30; i++){
			...
			if(i == 29){
				console.log(chalk.blue('=== setRewardRate to Full ==='));
				await stakingInstance_FRAX_WETH.setRewardRate(new BigNumber("4e17"), { from: STAKING_OWNER });
			...
			// Make sure there is a valid period for the contract
			await stakingInstance_FRAX_WETH.sync({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		...
		console.log("accounts[2] FXS balance change:", ((new BigNumber(await fxs_instance.balanceOf(accounts[2]))).minus(acc2_startingFXSbalance)).div(BIG18).toNumber());
		console.log("accounts[3] FXS balance change:", ((new BigNumber(await fxs_instance.balanceOf(accounts[3]))).minus(acc3_startingFXSbalance)).div(BIG18).toNumber());
