...
async function main() {
	...
	// const CurveAMO_V2 = await hre.ethers.getContractFactory("CurveAMO_V3");

	// console.log("Deploying contract");
	// const CurveAMO_V3_instance = await CurveAMO_V3.deploy(
	...
	// );
	// console.log("CurveAMO_V3 deployed to:", CurveAMO_V3_instance.address);

	// ==================== PROXY DEPLOYMENT ====================
  	const CurveAMO_V3 = await ethers.getContractFactory("CurveAMO_V3");
  	const curveProxy = await upgrades.deployProxy(CurveAMO_V3, [
		CONTRACT_ADDRESSES.mainnet.main.FRAX, 
		CONTRACT_ADDRESSES.mainnet.main.FXS, 
		CONTRACT_ADDRESSES.mainnet.collateral.USDC_V2, 
		COLLATERAL_FRAX_AND_FXS_OWNER, 
