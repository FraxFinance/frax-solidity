...
async function main() {
	...
	const FRAX3CRV_Curve_FXS_Distributor = await hre.ethers.getContractFactory("FRAX3CRV_Curve_FXS_Distributor");

	console.log("Deploying contract");
	const FRAX3CRV_Curve_FXS_Distributor_instance = await FRAX3CRV_Curve_FXS_Distributor.deploy(
	...
	console.log("FRAX3CRV_Curve_FXS_Distributor deployed to:", FRAX3CRV_Curve_FXS_Distributor_instance.address);

	// ==================== PROXY DEPLOYMENT ====================
  	// const CurveAMO_V2 = await ethers.getContractFactory("CurveAMO_V2");
  	// const curveProxy = await upgrades.deployProxy(CurveAMO_V2, [
	...
	// 	'0x72e158d38dbd50a483501c24f792bdaaa3e7d55c' // FRAX3CRV Gauge
	// ]);
  	// await curveProxy.deployed();
  	// console.log("Curve AMO V2 deployed to:", curveProxy.address);
}
