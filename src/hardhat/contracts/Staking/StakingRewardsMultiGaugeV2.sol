...
// |                                                                  |
// ====================================================================
// ==================== StakingRewardsMultiGaugeV2 ====================
// ====================================================================
// veFXS-enabled
// Multiple tokens with different reward rates can be emitted
// Multiple teams can set the reward rates for their token(s)
// Those teams can also use a gauge, or an external function
// New for V2: Can extend or add to existing locked stakes
// New for V2: Contract is aware of boosted veFXS (veFXSBoost)
...
contract StakingRewardsMultiGaugeV2 is Owned, ReentrancyGuard {
    ...
    // // For tests
    // function currTime() external returns (uint256) {
    ...
    function lockAdditional(bytes32 kek_id, uint256 addl_amt) updateRewardAndBalance(msg.sender, true) public {
        ...
        TransferHelper.safeTransferFrom(address(stakingToken), msg.sender, address(this), addl_amt);
    ...
    function set_veFXSBoostDelegationProxy(address _dlg_pxy_addr) external onlyByOwner {
