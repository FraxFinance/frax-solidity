...
contract FraxFarmRageQuitter_Saddle_L2D4 is ReentrancyGuard {
   IFarm public farm = IFarm(0xd1dF24e8D225b20F9c8f4912BE88cCCec93f36E5);
   IERC20 public lp_token = IERC20(0x147D0Af556C6D89640BFa915D2b9619d7b55947a);
   ...
   IERC20 public sdlToken = IERC20(0x75C9bC761d88f70156DAf83aa010E84680baF131);
   ...
   function ragequitOne(bytes32 _kek_id) nonReentrant external {
      ...
      SafeERC20.safeTransfer(sdlToken, msg.sender, sdlToken.balanceOf(address(this)));
   }
