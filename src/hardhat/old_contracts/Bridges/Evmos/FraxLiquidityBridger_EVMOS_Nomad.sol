...
contract FraxLiquidityBridger_EVMOS_Nomad is FraxLiquidityBridger {
    ...
    // NOTE: To collect tokens bridged from EVMOS, you must go here
    // https://app.nomad.xyz/tx/nomad/evmos/<EVMOS TX ID>
