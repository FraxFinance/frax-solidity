...
const UniswapPairOracle_FRAX_WETH = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_FRAX_WETH'
);
const UniswapPairOracle_FRAX_USDT = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_FRAX_USDT'
);
const UniswapPairOracle_FRAX_USDC = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_FRAX_USDC'
);
...
const UniswapPairOracle_FXS_WETH = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_FXS_WETH'
);
const UniswapPairOracle_FXS_USDT = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_FXS_USDT'
);
const UniswapPairOracle_FXS_USDC = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_FXS_USDC'
);
...
const UniswapPairOracle_USDT_WETH = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_USDT_WETH'
);
const UniswapPairOracle_USDC_WETH = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_USDC_WETH'
);
const UniswapPairOracle_6DEC_WETH = artifacts.require(
  'Oracle/Fakes/UniswapPairOracle_6DEC_WETH'
);
...
const StakingRewards_FRAX_WETH = artifacts.require(
  'Staking/Fake_Stakes/Stake_FRAX_WETH.sol'
);
const StakingRewards_FRAX_USDC = artifacts.require(
  'Staking/Fake_Stakes/Stake_FRAX_USDC.sol'
);
...
const StakingRewards_FXS_WETH = artifacts.require(
  'Staking/Fake_Stakes/Stake_FXS_WETH.sol'
);
...
contract('FRAX', async (accounts) => {
  ...
  beforeEach(async () => {
    ...
    pair_addr_6DEC_WETH = await uniswapFactoryInstance.getPair(
      FakeCollateral_6DEC.address,
      WETH.address,
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    );
  ...
  it('Check up on the oracles and make sure the prices are set', async () => {
    ...
    await oracle_instance_6DEC_WETH.update({
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });
    ...
    let USDT_price_from_USDT_WETH = new BigNumber(
      await oracle_instance_USDT_WETH.consult.call(WETH.address, 1e6)
    )
      .div(1e6)
      .toNumber();
    let USDC_price_from_USDC_WETH = new BigNumber(
      await oracle_instance_USDC_WETH.consult.call(WETH.address, 1e6)
    )
      .div(1e6)
      .toNumber();
    let DEC6_price_from_DEC6_WETH = new BigNumber(
      await oracle_instance_6DEC_WETH.consult.call(
        WETH.address,
        (1e18).toString()
      )
    )
    ...
    console.log(
      '6DEC_price_from_6DEC_WETH: ',
      DEC6_price_from_DEC6_WETH.toString(),
      ' 6DEC = 1 WETH'
    );
    ...
    USDC_price_from_USDC_WETH = new BigNumber(
      ...
      .div(1e6)
      .toNumber();
    DEC6_price_from_DEC6_WETH = new BigNumber(
      await oracle_instance_6DEC_WETH.consult.call(
        WETH.address,
        (1e18).toString()
      )
    ...
    console.log(
      '6DEC_price_from_pool: ',
      new BigNumber(await pool_instance_6DEC.getCollateralPrice.call())
        .div(1e6)
        .toString(),
      ' 6DEC = 1 USD'
    );
  ...
  it('Mints 6DEC 1-to-1', async () => {
    ...
    const collateral_before = new BigNumber(
      await col_instance_6DEC.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)
    ).div(BIG6);
    const pool_collateral_before = new BigNumber(
      await col_instance_6DEC.balanceOf.call(pool_instance_6DEC.address)
    ).div(BIG6);
    const collateral_price = new BigNumber(
      await pool_instance_6DEC.getCollateralPrice.call()
    )
      .div(BIG6)
      .toNumber();
    ...
    await col_instance_6DEC.approve(
      pool_instance_6DEC.address,
      collateral_amount,
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    );
    // Mint some FRAX
    console.log(
      'accounts[0] mint1t1FRAX() with 100 6DEC; slippage limit of 1%'
    );
    const FRAX_out_min = new BigNumber(
      collateral_amount.times(collateral_price).times(0.99)
    ); // 1% slippage
    await pool_instance_6DEC.mint1t1FRAX(collateral_amount, FRAX_out_min, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });
  ...
  it('Redeems 6DEC 1-to-1', async () => {
    ...
    await fraxInstance.approve(pool_instance_6DEC.address, frax_amount, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });

    // Redeem some FRAX
    await pool_instance_6DEC.redeem1t1FRAX(frax_amount, new BigNumber('10e6'), {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }); // Get at least 10 6DEC out, roughly 90% slippage limit (testing purposes)
    console.log('accounts[0] redeem1t1() with 100 FRAX');
    // Collect redemption; need to wait at least 3 blocks
    await time.advanceBlock();
    await time.advanceBlock();
    await time.advanceBlock();
    await pool_instance_6DEC.collectRedemption({
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });
    ...
    console.log(
      'accounts[0] 6DEC change: ',
      collateral_after.toNumber() - collateral_before.toNumber()
    );
    console.log(
      'FRAX_pool_6DEC change: ',
      pool_collateral_after.toNumber() - pool_collateral_before.toNumber()
    );
  ...
  it('Mint some FRAX using FXS and 6DEC (collateral ratio between .000001 and .999999) [mintFractionalFRAX]', async () => {
    ...
    await fxsInstance.approve(pool_instance_6DEC.address, fxs_amount, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });
    const collateral_amount = new BigNumber('100e6');
    await col_instance_6DEC.approve(
    ...
    await pool_instance_6DEC.mintFractionalFRAX(
      collateral_amount,
      fxs_amount,
      new BigNumber('10e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    ...
    console.log(
      'accounts[0] 6DEC balance change: ',
      collateral_after.toNumber() - collateral_before.toNumber()
    );
    console.log(
    ...
    console.log(
      'accounts[0] votes final:',
      (
        await fxsInstance.getCurrentVotes(COLLATERAL_FRAX_AND_FXS_OWNER)
      ).toString()
    );
    console.log(
      'accounts[0] FRAX balance change: ',
      frax_after.toNumber() - frax_before.toNumber()
    );
    console.log(
      'FRAX_pool_6DEC balance change: ',
      pool_collateral_after.toNumber() - pool_collateral_before.toNumber()
    );
  ...
  it('Redeem some FRAX for FXS and 6DEC (collateral ratio between .000001 and .999999) [redeemFractionalFRAX]', async () => {
    ...
    // Redeem some FRAX
    await pool_instance_6DEC.redeemFractionalFRAX(
      frax_amount,
      new BigNumber('10e18'),
      new BigNumber('10e6'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
  ...
  it('Recollateralizes the system using recollateralizeFRAX()', async () => {
    ...
    console.log(
      'pool_6DEC getCollateralPrice() (divided by 1e6):',
      new BigNumber(await pool_instance_6DEC.getCollateralPrice.call())
        .div(BIG6)
        .toNumber()
    );
    ...
    await col_instance_6DEC.approve(pool_instance_6DEC.address, DEC6_amount, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });

    // Redeem some FRAX
    await pool_instance_6DEC.recollateralizeFRAX(
      DEC6_amount,
      new BigNumber('10e6'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    );
  ...
  it('Mint some FRAX using FXS (collateral ratio = 0) [mintAlgorithmicFRAX]', async () => {
    ...
    // Mint some FRAX
    await pool_instance_6DEC.mintAlgorithmicFRAX(
      fxs_amount,
      new BigNumber('10e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    );
    ...
    console.log(
      'accounts[0] FXS balance after:',
      fxs_after.toNumber() - fxs_before.toNumber()
    );
    console.log(
      'accounts[0] FRAX balance after:',
      frax_after.toNumber() - frax_before.toNumber()
    );
  ...
  it('Redeem some FRAX for FXS (collateral ratio = 0) [redeemAlgorithmicFRAX]', async () => {
    ...
    // Redeem some FRAX
    await pool_instance_6DEC.redeemAlgorithmicFRAX(
      frax_amount,
      new BigNumber('10e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    );
  ...
  it('Buys back collateral using FXS [should fail if CR = 0]', async () => {
    ...
    const buyback_available = new BigNumber(
      await pool_instance_6DEC.availableExcessCollatDV.call()
    ).div(BIG18);
    ...
    await pool_instance_6DEC.buyBackFXS(fxs_amount, new BigNumber('10e6'), {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    });
    ...
    console.log('collateral_ratio_after: ', collateral_ratio_after.toNumber());
    console.log(
      'getCollateralPrice() from FRAX_pool_6DEC: ',
      new BigNumber(await pool_instance_6DEC.getCollateralPrice.call())
        .div(BIG6)
        .toNumber()
    );
