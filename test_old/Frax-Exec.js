...
const FakeCollateral_yUSD = artifacts.require(
  'FakeCollateral/FakeCollateral_yUSD'
);
...
const UniswapPairOracle_FRAX_yUSD = artifacts.require(
  'Oracle/Variants/UniswapPairOracle_FRAX_yUSD'
);
...
const UniswapPairOracle_FXS_yUSD = artifacts.require(
  'Oracle/Variants/UniswapPairOracle_FXS_yUSD'
);
