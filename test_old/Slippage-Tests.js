...
const StakingRewards_FRAX_USDT = artifacts.require(
  'Staking/Variants/Stake_FRAX_USDT.sol'
);
...
const StakingRewards_FXS_USDC = artifacts.require(
  'Staking/Variants/Stake_FXS_USDC.sol'
);
const StakingRewards_FXS_USDT = artifacts.require(
  'Staking/Variants/Stake_FXS_USDT.sol'
);
...
*/
  ...
  it('redeemFractionalFRAX() - Testing slippage, FXS amountOut passing && USDC amountOut passing', async () => {
    ...
    console.log(
      'accounts[0] USDC balance change:',
  ...
  it('mintFractionalFRAX, FRAX amountOut trivially passes', async () => {
    ...
    console.log(
      'accounts[0] mintFractionalFRAX() with 10,000 USDC and 50,000 FXS; FRAX_out_min: ',
      FRAX_out_min.div(BIG18).toNumber()
    );
  ...
  it('mintFractionalFRAX, FRAX amountOut passes', async () => {
    ...
    const FRAX_out_min = new BigNumber(
      collateral_amount
        .times(await pool_instance_USDC.getCollateralPrice())
    ...
    console.log(
      'accounts[0] mintFractionalFRAX() with 10,000 USDC and 50,000 FXS; FRAX_out_min_2: ',
      FRAX_out_min_2.toNumber()
    );
    await pool_instance_USDC.mintFractionalFRAX(
      collateral_amount,
      fxs_amount,
  ...
  it('mintFractionalFRAX, FRAX amountOut fails', async () => {
    ...
    console.log(
      'accounts[0] mintFractionalFRAX() with 10,000 USDC and 50,000 FXS; FRAX_out_min_3: ',
      FRAX_out_min_3.toNumber()
    );
    await pool_instance_USDC.mintFractionalFRAX(
      collateral_amount,
      fxs_amount,
