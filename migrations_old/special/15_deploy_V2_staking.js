...
const StakingRewards_FRAX_WETH = artifacts.require(
  'Staking/Variants/Stake_FRAX_WETH'
);
const StakingRewards_FRAX_USDC = artifacts.require(
  'Staking/Variants/Stake_FRAX_USDC'
);
const StakingRewards_FRAX_FXS = artifacts.require(
  'Staking/Variants/Stake_FRAX_FXS'
);
const StakingRewards_FXS_WETH = artifacts.require(
  'Staking/Variants/Stake_FXS_WETH'
);

// Staking contracts V2
const StakingRewards_FRAX_WETH_V2 = artifacts.require(
  'Staking/Variants/Stake_FRAX_WETH_V2'
);
const StakingRewards_FRAX_USDC_V2 = artifacts.require(
  'Staking/Variants/Stake_FRAX_USDC_V2'
);
const StakingRewards_FRAX_FXS_V2 = artifacts.require(
  'Staking/Variants/Stake_FRAX_FXS_V2'
);
const StakingRewards_FXS_WETH_V2 = artifacts.require(
  'Staking/Variants/Stake_FXS_WETH_V2'
);
...
module.exports = async function (deployer, network, accounts) {
  ...
  await deployer.link(Math_Artifact, [
    StakingRewards_FRAX_WETH_V2,
    StakingRewards_FRAX_USDC_V2,
    StakingRewards_FRAX_FXS_V2,
    StakingRewards_FXS_WETH_V2,
  ]);

  console.log(chalk.blue('--- Linking TransferHelper ---'));
  await deployer.link(TransferHelper, [
    StakingRewards_FRAX_WETH_V2,
    StakingRewards_FRAX_USDC_V2,
    StakingRewards_FRAX_FXS_V2,
    StakingRewards_FXS_WETH_V2,
  ...
  await deployer.link(FRAXStablecoin, [
    StakingRewards_FRAX_WETH_V2,
    StakingRewards_FRAX_USDC_V2,
    StakingRewards_FXS_WETH_V2,
    StakingRewards_FRAX_FXS_V2,
  ...
  await deployer.link(StringHelpers, [
    StakingRewards_FRAX_WETH_V2,
    StakingRewards_FRAX_USDC_V2,
    StakingRewards_FXS_WETH_V2,
    StakingRewards_FRAX_FXS_V2,
  ...
  const stakingInstance_FRAX_WETH_V2 =
    await StakingRewards_FRAX_WETH_V2.deployed();
  const stakingInstance_FRAX_USDC_V2 =
    await StakingRewards_FRAX_USDC_V2.deployed();
  const stakingInstance_FRAX_FXS_V2 =
    await StakingRewards_FRAX_FXS_V2.deployed();
  const stakingInstance_FXS_WETH_V2 =
    await StakingRewards_FXS_WETH_V2.deployed();

  // Transfer FXS to staking contracts
  console.log(chalk.yellow('===== Transfer FXS to staking contracts ====='));
  await Promise.all([
    fxsInstance.transfer(
      stakingInstance_FRAX_WETH_V2.address,
      new BigNumber('100000e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    ), // eventually should be 6000000e18
    fxsInstance.transfer(
      stakingInstance_FRAX_USDC_V2.address,
      new BigNumber('100000e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    ), // eventually should be 6000000e18
    fxsInstance.transfer(
      stakingInstance_FRAX_FXS_V2.address,
      new BigNumber('100e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    ), // eventually should be 1000000e18
    fxsInstance.transfer(
      stakingInstance_FXS_WETH_V2.address,
      new BigNumber('100e18'),
      {from: COLLATERAL_FRAX_AND_FXS_OWNER}
    ), // eventually should be 1000000e18
  ]);
