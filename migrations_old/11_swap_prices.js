...
module.exports = async function (deployer, network, accounts) {
  ...
  if (true) {
    ...
    await Promise.all([
      ...
      col_instance_USDC.approve(
        routerInstance.address,
        new BigNumber(2000000e18),
        {from: COLLATERAL_FRAX_AND_FXS_OWNER}
      ),
      col_instance_USDT.approve(
        routerInstance.address,
        new BigNumber(2000000e18),
        {from: COLLATERAL_FRAX_AND_FXS_OWNER}
      ),
      fraxInstance.approve(routerInstance.address, new BigNumber(1000000e18), {
        from: COLLATERAL_FRAX_AND_FXS_OWNER,
      }),
      fxsInstance.approve(routerInstance.address, new BigNumber(5000000e18), {
        from: COLLATERAL_FRAX_AND_FXS_OWNER,
      }),
    ]);
  ...
  console.log(
    chalk.red.bold(
      'YOU NEED TO WAIT AT LEAST 24 HOURS HERE NORMALLY, BUT TEMPORARILY RESETTING THE PRICE UPDATE TO ONE SECOND'
    )
  );
  console.log(
  ...
  await Promise.all([
    oracle_instance_FRAX_WETH.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FRAX_USDC.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FRAX_USDT.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FRAX_FXS.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FXS_WETH.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FXS_USDC.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FXS_USDT.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_USDC_WETH.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_USDT_WETH.setPeriod(1, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
  ]);
  ...
  await Promise.all([
    oracle_instance_FRAX_WETH.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FRAX_USDC.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FRAX_USDT.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FRAX_FXS.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FXS_WETH.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FXS_USDC.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_FXS_USDT.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_USDC_WETH.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
    oracle_instance_USDT_WETH.setPeriod(3600, {
      from: COLLATERAL_FRAX_AND_FXS_OWNER,
    }),
  ]);
};
