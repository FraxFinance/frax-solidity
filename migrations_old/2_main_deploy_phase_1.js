...
module.exports = async function (deployer, network, accounts) {
  ...
  await deployer.link(FixedPoint, [
  ...
  await deployer.link(UniswapV2Library, [
    UniswapPairOracle_FRAX_WETH,
    UniswapPairOracle_FRAX_USDC,
    UniswapPairOracle_FXS_WETH,
    UniswapPairOracle_FXS_USDC,
  ...
  await governanceInstance.__setTimelockAddress(timelockInstance.address, {
  ...
  await migrationHelperInstance.setGovToTimeLockETA(eta_with_delay, {
    from: TIMELOCK_ADMIN,
  });
